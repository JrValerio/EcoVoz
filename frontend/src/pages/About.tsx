...
/**
 * Componente que renderiza a página "Sobre" da aplicação.
 * Exibe informações sobre o projeto EcoVoz, incluindo sua descrição, funcionalidades, missão e equipe.
 */
const About: React.FC = () => {
  ...
  return (
    ...
    >
      ...
      {/* Seção sobre a missão do projeto */}
      <section className="max-w-2xl mb-6">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">
      ...
      {/* Seção sobre a equipe do projeto */}
      <section className="max-w-2xl mb-6">
        <h2 className="text-2xl font-bold text-gray-800 dark:text-gray-200 mb-4">
